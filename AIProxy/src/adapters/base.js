...
示例 1（无时间线索）：
输入："帮我记一下买菜"
输出：{"todos":[{"title":"买菜","detail":"帮我记一下买菜","due_date":null,"due_hint":null,"due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"life"}],"ignored":""}

示例 2（带钟点，假设参考日期 2026-07-12 周日）：
输入："明天下午3点开会"
输出：{"todos":[{"title":"开会","detail":"明天下午3点","due_date":"2026-07-13","due_hint":"明天下午3点","due_time":"15:00","time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"work"}],"ignored":""}

示例 3（月度重复 + 钟点）：
输入："每个月15号下午3点发工资提醒"
输出：{"todos":[{"title":"发工资提醒","detail":"每个月15号下午3点","due_date":null,"due_hint":"每个月15号下午3点","due_time":"15:00","time_bucket":null,"recurrence_rule":{"frequency":"monthly","weekdays":[],"day_of_month":15,"end_date":null},"recurrence_end":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

示例 4（周重复多天）：
输入："每周一三五晚上8点去健身房"
输出：{"todos":[{"title":"去健身房","detail":"每周一三五晚上8点","due_date":null,"due_hint":"每周一三五晚上8点","due_time":"20:00","time_bucket":null,"recurrence_rule":{"frequency":"weekly","weekdays":[2,4,6],"day_of_month":null,"end_date":null},"recurrence_end":null,"priority":"normal","category_hint":"health"}],"ignored":""}

示例 5（有限周期 + 每天 + 钟点）：
输入："未来一个月每天下午3点来接孩子"
输出：{"todos":[{"title":"接孩子","detail":"未来一个月每天下午3点","due_date":null,"due_hint":"未来一个月每天下午3点","due_time":"15:00","time_bucket":null,"recurrence_rule":{"frequency":"daily","weekdays":[],"day_of_month":null,"end_date":null},"recurrence_end":{"kind":"after_count","count":1,"unit":"month"},"priority":"normal","category_hint":"life"}],"ignored":""}

示例 6（重复 + 非"未来N"截止边界）：
输入："每天晚上8点吃药，到这个月底"
输出：{"todos":[{"title":"吃药","detail":"每天晚上8点吃药，到这个月底","due_date":null,"due_hint":"每天晚上8点","due_time":"20:00","time_bucket":null,"recurrence_rule":{"frequency":"daily","weekdays":[],"day_of_month":null,"end_date":null},"recurrence_end":{"kind":"month_end","scope":"this"},"priority":"normal","category_hint":"health"}],"ignored":""}

示例 7（相对日期换算，假设参考日期 2026-07-12 周日）：
输入："下周三交房租"
输出：{"todos":[{"title":"交房租","detail":"下周三交房租","due_date":"2026-07-15","due_hint":"下周三","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

示例 8（N天后换算，假设参考日期 2026-07-12）：
输入："三天后下午3点开会"
输出：{"todos":[{"title":"开会","detail":"三天后下午3点开会","due_date":"2026-07-15","due_hint":"三天后下午3点","due_time":"15:00","time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"work"}],"ignored":""}

示例 9（模糊晚上，不虚构钟点；假设参考日期 2026-07-12）：
输入："今天晚上去健身"
输出：{"todos":[{"title":"去健身","detail":"今天晚上","due_date":"2026-07-12","due_hint":"今天晚上","due_time":null,"time_bucket":"evening","recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"health"}],"ignored":""}

示例 10（一次性任务截止日，不是 recurrence_end；参考日期 2026-07-15）：
输入："这个月底前交税"
输出：{"todos":[{"title":"交税","detail":"这个月底前交税","due_date":"2026-07-31","due_hint":"这个月底前","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

示例 11（interval 重复）：
输入："每两周大扫除一次"
输出：{"todos":[{"title":"大扫除","detail":"每两周大扫除一次","due_date":null,"due_hint":"每两周一次","due_time":null,"time_bucket":null,"recurrence_rule":{"frequency":"weekly","interval":2,"weekdays":[],"day_of_month":null,"end_date":null},"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"life"}],"ignored":""}

示例 12（多时间点提醒）：
输入："下午3点、5点、7点喝水提醒"
输出：{"todos":[{"title":"喝水提醒","detail":"下午3点、5点、7点","due_date":null,"due_hint":"下午3点、5点、7点","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":["15:00","17:00","19:00"],"priority":"normal","category_hint":"health"}],"ignored":""}

示例 13（模糊日期换算；参考日期 2026-07-15 周三）：
输入："这周末去爬山"
输出：{"todos":[{"title":"去爬山","detail":"这周末去爬山","due_date":"2026-07-18","due_hint":"这周末","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"life"}],"ignored":""}`;
...
Output: {"todos":[{"title":"Buy groceries","detail":"Remind me to buy groceries","due_date":null,"due_hint":null,"due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"life"}],"ignored":""}

Example 2 (with clock time, assume reference date 2026-07-12 Sunday):
Input: "Meeting tomorrow at 3pm"
Output: {"todos":[{"title":"Meeting","detail":"tomorrow at 3pm","due_date":"2026-07-13","due_hint":"tomorrow at 3pm","due_time":"15:00","time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"work"}],"ignored":""}

Example 3 (monthly recurrence + clock time):
Input: "Salary reminder on the 15th of every month at 3pm"
Output: {"todos":[{"title":"Salary reminder","detail":"15th of every month at 3pm","due_date":null,"due_hint":"15th of every month at 3pm","due_time":"15:00","time_bucket":null,"recurrence_rule":{"frequency":"monthly","weekdays":[],"day_of_month":15,"end_date":null},"recurrence_end":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

Example 4 (weekly recurrence, multiple weekdays):
Input: "Gym every Mon/Wed/Fri at 8pm"
Output: {"todos":[{"title":"Go to gym","detail":"every Mon/Wed/Fri at 8pm","due_date":null,"due_hint":"every Mon/Wed/Fri at 8pm","due_time":"20:00","time_bucket":null,"recurrence_rule":{"frequency":"weekly","weekdays":[2,4,6],"day_of_month":null,"end_date":null},"recurrence_end":null,"priority":"normal","category_hint":"health"}],"ignored":""}
...
Output: {"todos":[{"title":"Pay rent","detail":"pay the rent next Wednesday","due_date":"2026-07-15","due_hint":"next Wednesday","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

Example 8 (N days from now, assume reference date 2026-07-12):
Input: "I have a meeting at 3pm three days from now"
Output: {"todos":[{"title":"Meeting","detail":"meeting at 3pm three days from now","due_date":"2026-07-15","due_hint":"three days from now","due_time":"15:00","time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"work"}],"ignored":""}

Example 9 (fuzzy evening without inventing a clock time; reference date 2026-07-12):
Input: "Go to the gym tonight"
Output: {"todos":[{"title":"Go to gym","detail":"tonight","due_date":"2026-07-12","due_hint":"tonight","due_time":null,"time_bucket":"evening","recurrence_rule":null,"recurrence_end":null,"priority":"normal","category_hint":"health"}],"ignored":""}
...
Output: {"todos":[{"title":"Finish filing taxes","detail":"Finish filing my taxes by the end of this month","due_date":"2026-07-31","due_hint":"by the end of this month","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"finance"}],"ignored":""}

Example 11 (interval recurrence):
Input: "Do a deep clean once every two weeks"
Output: {"todos":[{"title":"Deep clean","detail":"once every two weeks","due_date":null,"due_hint":"once every two weeks","due_time":null,"time_bucket":null,"recurrence_rule":{"frequency":"weekly","interval":2,"weekdays":[],"day_of_month":null,"end_date":null},"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"life"}],"ignored":""}

Example 12 (multiple reminder times):
Input: "Remind me to drink water at 3 p.m., 5 p.m., and 7 p.m."
Output: {"todos":[{"title":"Drink water","detail":"at 3 p.m., 5 p.m., and 7 p.m.","due_date":null,"due_hint":"at 3 p.m., 5 p.m., and 7 p.m.","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":["15:00","17:00","19:00"],"priority":"normal","category_hint":"health"}],"ignored":""}
...
Output: {"todos":[{"title":"Go hiking","detail":"this weekend","due_date":"2026-07-18","due_hint":"this weekend","due_time":null,"time_bucket":null,"recurrence_rule":null,"recurrence_end":null,"reminder_times":null,"priority":"normal","category_hint":"life"}],"ignored":""}`;
